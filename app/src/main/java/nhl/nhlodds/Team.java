...
public class Team implements Parcelable {
    private String name, abbreviation, games_played, wins, losses, rank, points, streak;
    private int logo;
    ...
    public void clear() {
        name = abbreviation = games_played = wins  = losses = rank = points = streak = "";
        logo = -1;
    }
    ...
    public void set_abbreviation (String s) {
        abbreviation = s;
    }
    public void set_games_played (String s) {
        games_played = s;
    }
    public void set_wins(String s) {
        wins = s;
    }
    public void set_losses(String s) {
        losses = s;
    }
    public void set_rank (String s) {
        rank = s;
    }
    public void set_points (String s) {
        points = s;
    }
    public void set_streak (String s) {
        streak = s;
    }
